...
Static personal homepage for `brice94.github.io`.
...
- Opens a GitHub issue against `brice94/brice94.github.io`.
...
1. Create a GitHub repository named `brice94.github.io`.
...
8. Open `https://brice94.github.io/`.
